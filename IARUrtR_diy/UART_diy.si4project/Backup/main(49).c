...
#define PD3_ON   (PD_ODR_ODR3 = 1;SelfInfo.NowStatus |= 0x2;)
#define PD3_OFF  (PD_ODR_ODR3 = 0;SelfInfo.NowStatus &= ~0x2;)
#define PD2_ON   (PD_ODR_ODR2 = 1;SelfInfo.NowStatus |= 0x1;)
#define PD2_OFF  (PD_ODR_ODR2 = 0;SelfInfo.NowStatus &= ~0x1;)
